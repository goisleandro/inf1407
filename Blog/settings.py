...
SECRET_KEY = 'django-insecure-_@pn3i$2lz)q4*$++#(6jb048ucim+u^ru-1jb1(q+p&3(p1dh'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.vercel.app', '.now.sh' ,'http://127.0.0.1:8000/', 'https://inf1407-blog.herokuapp.com/']
...
#verificar qual banco de dados: desenvolvimento ou ambiente
#dj-database será o responsável pelas configurações
